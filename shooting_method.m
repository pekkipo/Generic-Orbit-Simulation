...
function [x y] = shooting_method(fun,h,zero,a,b,con,type,init)  
    ...
    [~, F1] = rkv89emb_maneuvers(@force_model_maneuvers, [init_epoch final_epoch], init_state);%RungeKutta(a,b,h,a1,fun); 
    [~, F2] = rkv89emb_maneuvers(@force_model_maneuvers, [init_epoch final_epoch], init_state);        
