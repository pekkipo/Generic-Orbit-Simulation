...
%global G;
    ...
    field10 = 'coords'; value10 = [];
        ...
        Jupiter_coords = cspice_spkezr ( bodies{2,pl}, t, 'J2000', 'NONE', observer );
        ...
        Venus_coords = cspice_spkezr ( bodies{2,pl}, t, 'J2000', 'NONE', observer );
        ...
        Mars.mass = (Mars.GM)/G;
        Mars_coords = cspice_spkezr ( bodies{2,pl}, t, 'J2000', 'NONE', observer );
        ...
        Saturn_coords = cspice_spkezr ( bodies{2,pl}, t, 'J2000', 'NONE', observer );
